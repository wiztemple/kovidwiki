...
const Navbar = () => {
  ...
  const getLinkClass = (path: string) => {
    return pathname === path
      ? `${textClass} bg-white dark:bg-[#070e29] text-[#454E5E] dark:text-slate-500 shadow-menuShadow`
      : textClass;
  };
  ...
  const buttonClass = `flex items-center gap-x-3 sm:w-fit w-full px-3 py-2 text-[#2C3E50] dark:text-slate-400 font-medium text-sm border border-[#F1F4FA] dark:border-slate-800 rounded-[10px] hover:bg-[#FAF9F9] hover:border-[#FAF9F9] dark:hover:bg-[#070e29] dark:hover:border-[#070e29]`;
  return (
    <nav className="sm:flex justify-between items-center w-full shadow-xs sm:px-20 px-5 sm:h-[56px] sm:py-0 py-2 shadow-headerShadow dark:bg-[#0B1023] dark:border-b dark:border-b-gray-800">
      <div className="flex rounded bg-[#F7F9FD] dark:bg-[#111730] items-center py-1 px-2">
